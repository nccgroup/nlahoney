...
{
	UINT8 RespType;					// Dynamic
	UINT8 HiRespType;				// Dynamic
	UINT16 Reserved1;				// Static
	UINT32 Reserved2;				// Static
	BYTE Timestamp[8];				// Dynamic
	BYTE ClientChallenge[8];		// Dynamic
	UINT32 Reserved3;				// Static
	NTLM_AV_PAIR* AvPairs;			// Dynamic
	UINT32 cbAvPairs;				// Dynamic
};
...
{
	BYTE Signature[8];      		 // Static
	UINT32 MessageType;     		 // Static
	UINT32 NegotiateFlags; 			 // Dynamic
	NTLM_VERSION_INFO Version;       // Dynamic
	NTLM_MESSAGE_FIELDS DomainName;  // Dynamic
	NTLM_MESSAGE_FIELDS Workstation; // Dynamic
};
...
struct _NTLM_CHALLENGE_MESSAGE
{
	...
	UINT32 MessageType;              // Static
	UINT32 NegotiateFlags;           // Dynamic
	BYTE ServerChallenge[8];		 // Dynamic - but we can set to static
	BYTE Reserved[8];                // Static
	NTLM_VERSION_INFO Version;		 // Static
	NTLM_MESSAGE_FIELDS TargetName;	 // Static
	NTLM_MESSAGE_FIELDS TargetInfo;	 // Static
};
