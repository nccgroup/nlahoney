...
{
	WLog_INFO(TAG,"[HONEY] ntlm_SetContextWorkstation");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_SetContextServicePrincipalNameW");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_SetContextTargetName");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_ContextNew");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_ContextFree");
    ...
    PTimeStamp ptsExpiry)
{
	...
	WLog_INFO(TAG,"[HONEY] ntlm_AcquireCredentialsHandleW");
...
static SECURITY_STATUS SEC_ENTRY ntlm_AcquireCredentialsHandleA(	
    ...
    PTimeStamp ptsExpiry)
{
	WLog_INFO(TAG,"[HONEY] ntlm_AcquireCredentialsHandleA");
...
static SECURITY_STATUS SEC_ENTRY ntlm_FreeCredentialsHandle(PCredHandle phCredential)
{
	...
	WLog_INFO(TAG,"[HONEY] ntlm_FreeCredentialsHandle");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_QueryCredentialsAttributesW");
...
static SECURITY_STATUS SEC_ENTRY ntlm_QueryCredentialsAttributesA(PCredHandle phCredential,
                                                                  ULONG ulAttribute, void* pBuffer)
{
	WLog_INFO(TAG,"[HONEY] ntlm_QueryCredentialsAttributesA");
                           ...
                           PSecBufferDesc pOutput, PULONG pfContextAttr, PTimeStamp ptsTimeStamp)
{
	...
	WLog_INFO(TAG,"[HONEY] ** ntlm_AcceptSecurityContext");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_InitializeSecurityContextW");
...
static SECURITY_STATUS SEC_ENTRY ntlm_InitializeSecurityContextA(
    ...
    PCtxtHandle phNewContext, PSecBufferDesc pOutput, PULONG pfContextAttr, PTimeStamp ptsExpiry)
{
	WLog_INFO(TAG,"[HONEY] ntlm_InitializeSecurityContextA");
                                                        ...
                                                        PSecBufferDesc pToken)
{
	...
	WLog_INFO(TAG,"[HONEY] ntlm_CompleteAuthToken");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_DeleteSecurityContext");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_computeProofValue");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_computeMicValue");
...
static SECURITY_STATUS SEC_ENTRY ntlm_QueryContextAttributesW(PCtxtHandle phContext,
                                                              ULONG ulAttribute, void* pBuffer)
{
	WLog_INFO(TAG,"[HONEY] ntlm_QueryContextAttributesW");
...
static SECURITY_STATUS SEC_ENTRY ntlm_QueryContextAttributesA(PCtxtHandle phContext,
                                                              ULONG ulAttribute, void* pBuffer)
{
	WLog_INFO(TAG,"[HONEY] ntlm_QueryContextAttributesA");
...
static SECURITY_STATUS SEC_ENTRY ntlm_SetContextAttributesW(PCtxtHandle phContext,
                                                            ...
                                                            ULONG cbBuffer)
{
	WLog_INFO(TAG,"[HONEY] ntlm_SetContextAttributesW");
	WLog_INFO(TAG,"[HONEY]   --- where we calculate AuthNtlmMessage and put in AuthenticateMessage");
	WLog_INFO(TAG,"[HONEY]   --- this is the bit we need to generate unique");
	NTLM_CONTEXT* context;
...
static SECURITY_STATUS SEC_ENTRY ntlm_SetContextAttributesA(PCtxtHandle phContext,
                                                            ...
                                                            ULONG cbBuffer)
{
	WLog_INFO(TAG,"[HONEY] ntlm_SetContextAttributesA");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_RevertSecurityContext");
	return SEC_E_OK;
}
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_EncryptMessage");
...
{
	WLog_INFO(TAG,"[HONEY] ntlm_DecryptMessage");
